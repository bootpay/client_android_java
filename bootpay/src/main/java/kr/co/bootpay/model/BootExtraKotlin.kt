...
class BootExtraKotlin {
    ...
    fun setStartAt(value: String?): BootExtraKotlin {
        start_at = value
        return this
    }

    fun setEndAt(value: String?): BootExtraKotlin {
        end_at = value
        return this
    }

    fun setExpireMonth(value: Int?): BootExtraKotlin {
        expire_month = value
        return this
    }

    fun setVbankResult(value: Boolean): BootExtraKotlin {
        vbank_result = value
        return this
    }

    fun setQuotas(value: IntArray?): BootExtraKotlin {
        quotas = value
        return this
    }

    fun setAppScheme(value: String?): BootExtraKotlin {
        app_scheme = value
        return this
    }

    fun setAppSchemeHost(value: String?): BootExtraKotlin {
        app_scheme_host = value
        return this
    }

    fun setUX(value: String): BootExtraKotlin {
        ux = value
        return this
    }

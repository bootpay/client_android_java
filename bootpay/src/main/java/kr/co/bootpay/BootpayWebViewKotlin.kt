...
internal class BootpayWebViewKotlin @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0): WebView(context, attrs, defStyleAttr) {

    companion object {
        private const val BOOTPAY = "https://inapp.bootpay.co.kr/3.0.2/production.html"
...
////    }
////
////    fun setDialog(dialog: Dialog): BootpayWebViewKotlin {
////        this.dialog = dialog
////        return this
////    }
////
...
////
////    fun useOnestoreApi() {
////        if(UserInfo.enable_onstore) {
////            load("window.BootPay.useOnestoreApi({ad_id: '${UserInfo.ad_id}', sim_operation: '${UserInfo.sim_operator}', installerPackageName: '${UserInfo.install_package_market}'});")
////        }
////    }
////
//////    fun useOnestoreApi(adid: String?, sim: String?, market_name: String?) {
//////        load("window.BootPay.useOnestoreApi({ad_id: '${adid ?: "UNKNOWN_ADID"}', sim_operation: '${sim ?: "UNKNOWN_SIM_OPERATOR"}', installerPackageName: '${market_name ?: "UNKNOWN_INSTALLER"}'});")
//////    }
////
...
////
////
////    fun setData(request: Request?): BootpayWebViewKotlin {
...
//                CookieManager.getInstance().setAcceptCookie(true)
//                CookieManager.getInstance().setAcceptThirdPartyCookies(this@BootpayWebViewKotlin, true)
//            }

...
final class BootpayWebView extends WebView {
    private static final String BOOTPAY = "https://dev-inapp.bootpay.co.kr/1.0.0/development.html";
...
//        return url != null && (url.startsWith("intent://") || url.startsWith("intent:hdcardappcardansimclick://"));
    }
